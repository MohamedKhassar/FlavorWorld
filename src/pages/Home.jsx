...
const DeleteData = async (id) => {
    try {
        ...
        const confirmDelete = window.confirm("Are you sure for this delete")
        if (confirmDelete) {
