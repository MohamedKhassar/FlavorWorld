...
const Home = () => {
  ...
  return (
    <header className="w-full h-full ">
     ...
     <h1 className="font-extrabold" >Welcome to Flavor World</h1>
      <p className=" m-9 text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo, voluptatum pariatur, cupiditate est sapiente expedita quia assumenda illo aliquid quam sed rerum laborum similique impedit tenetur earum! Sit, odio dolore!
